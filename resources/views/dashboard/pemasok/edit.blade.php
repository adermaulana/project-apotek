...
<h6>Nama Pemasok</h6>
<input type="text" name="nama_pemasok" value="{{ old('nama_pemasok',$pemasok->nama_pemasok) }}" class="form-control" >
@error('nama_pemasok')
...
<div class="form-group">
<h6>Alamat</h6>
<input type="text" name="alamat" value="{{ old('alamat',$pemasok->alamat) }}" class="form-control" >
@error('alamat')
<div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
@enderror
</div>
