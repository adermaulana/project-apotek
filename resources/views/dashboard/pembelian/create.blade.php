...
<div class="form-group">
<h6>Harga Beli</h6>
<input type="text" name="harga_beli" value="{{ old('harga_beli') }}" class="form-control" >
@error('harga_beli')
<div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
@enderror
</div>
...
<div class="form-group">
<h6>Banyak</h6>
<input type="text" name="banyak" value="{{ old('banyak') }}" class="form-control" >
@error('banyak')
<div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
@enderror
</div>
...
<div class="form-group">
<h6>Tanggal Beli</h6>
<input type="text" name="tanggal_beli" value="{{ old('tanggal_beli') }}" class="form-control" >
@error('tanggal_beli')
<div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
@enderror
</div>
