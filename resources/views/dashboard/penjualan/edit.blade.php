...
<h6>Nama Pembeli</h6>
<input type="text" name="nama_pembeli" id="nama_pembeli" value="{{ old('nama_pembeli',$penjualan->nama_pembeli) }}" class="form-control"  >
@error('nama_pembeli')
...
<option value="0"></option>
        ...
        @if(old('obat_id',$penjualan->obat_id) == $obats->id)
