<a href="{{ route('obat.edit',$id) }}" data-toggle="tooltip" data-original-title="Edit" class="edit btn btn-success edit" >
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <form action="{{ route('obat.destroy',$id) }}" method="post" class="d-inline">
                    @method('delete')
                    @csrf
